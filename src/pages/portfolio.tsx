...
const Portfolio = () => {
  ...
  return (
    <div className="bg-primary h-auto lg:h-[100vh] w-full ">
      {/* Section Title */}
      <div className="relative text-center pt-10">
        ...
        <p className="relative text-[3.8vh] font-black z-10 mr-[25vh] sm:mr-0 sm:text-center">
          <span className="text-white sm:text-[8vh] font-black">MY</span>
      ...
      {/* Image Grid */} 
      <div className="w-full mt-16   h-auto px-3 md:px-9 lg:px-36 lg:mt-10">
