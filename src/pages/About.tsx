...
const About = () => {
  return (
    <div className="w-full bg-primary h-auto">
      <div class="relative text-center pt-10">
        <p class="absolute text-[8vh] text-customGray font-back top-[80%] left-[20%] transform -translate-x-[50%] -translate-y-[50%] whitespace-nowrap z-0 sm:top-[50%] sm:left-[50%]">
          RESUME
        </p>

        <p class="relative text-[5vh] font-black z-10 mr-[25vh] sm:mr-0 sm:text-center">
          <span class="text-white font-mono sm:text-[8vh]">ABOUT</span>
          <span class="text-secondary px-1 font-mono sm:text-[8vh]">ME</span>
        </p>
      </div>

      <p className="mt-10 text-[4vh] pl-2 font-bold text-white font-mono lg:ml-2 xl:ml-[20vh]">
        PERSONAL INFO{" "}
      </p>
  ...
  <div className="lg:w-[50%]">
    ...
    <div className="flex gap-[15.4vh] mt-7 sm:gap-[15.2vh] lg:gap-[21.2vh]">
      <div className="ml-2 sm:flex sm:gap-3">
        <h1 className="text-white font-mono text-[2.5vh]">Age:</h1>
        <p className="text-customGray2 text-[2.5vh]">21</p>
      </div>
      <div className="sm:flex">
        <h1 className="text-white font-mono text-[2.5vh] sm:ml-[6vh] lg:ml-0">
          Nationality:
        </h1>
    ...
    <div className="flex gap-[7vh] mt-7">
      <div className="ml-2 sm:flex">
        <h1 className="text-white font-mono text-[2.5vh]">Freelance:</h1>
        <p className="text-green-500 text-[2.5vh]">Available</p>
      </div>
      <div className="sm:flex">
        <h1 className="text-white font-mono text-[2.5vh] sm:ml-1">Address:</h1>
    ...
    <div className="flex gap-12 mt-7">
      <div className="ml-2 sm:flex">
        <h1 className="text-white font-mono text-[2.5vh]">Phone:</h1>
        <p className="text-customGray2 text-[2.5vh]">09041329588</p>
      </div>
      <div className="sm:flex">
        <h1 className="text-white font-mono text-[2.5vh] sm:ml-4">Email:</h1>
